...
def get_arguments():
    ...
    parser.add_argument("--model", type=str, default=MODEL, help="available options : DeepLab")
    ...
    parser.add_argument(
        "--iter-size", type=int, default=ITER_SIZE, help="Accumulate gradients for ITER_SIZE iterations."
    )
    parser.add_argument(
        "--num-workers", type=int, default=NUM_WORKERS, help="number of workers for multithread dataloading."
    )
    parser.add_argument(
        "--data-dir", type=str, default=DATA_DIRECTORY, help="Path to the directory containing the source dataset."
    )
    parser.add_argument(
        "--data-dir-acdc",
        type=str,
        default=DATA_DIRECTORY_ACDC,
        help="Path to the directory containing the source dataset.",
    )
    parser.add_argument(
        "--data-dir-nightcity",
        type=str,
        default=DATA_DIRECTORY_NIGHTCITY,
        help="Path to the directory containing the source dataset.",
    )
    parser.add_argument(
        "--data-list",
    ...
    parser.add_argument(
        "--data-list-acdc-night",
        type=str,
        default=DATA_LIST_PATH_ACDC_NIGHT,
        help="Path to the file listing the images in the source dataset.",
    )
    parser.add_argument(
        "--data-list-nightcity",
        type=str,
        default=DATA_LIST_PATH_NIGHTCITY,
        help="Path to the file listing the images in the source dataset.",
    )
    parser.add_argument(
