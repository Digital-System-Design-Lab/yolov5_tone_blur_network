...
from .backbone import hrnetv2, mobilenetv2, resnet
...
def _segm_resnet(name, backbone_name, num_classes, output_stride, dgf, pretrained_backbone):
    if output_stride == 8:
    ...
    model = DeepLabV3(backbone, classifier, dgf)
    return model
...
def _load_model(arch_type, backbone, num_classes, output_stride, dgf, pretrained_backbone):
...
def deeplabv3_resnet101(num_classes=21, output_stride=8, dgf=False, pretrained_backbone=True):
    """
...
def deeplabv3_mobilenet(num_classes=21, output_stride=8, pretrained_backbone=True, **kwargs):
    ...
    """
    return _load_model(
        "deeplabv3", "mobilenetv2", num_classes, output_stride=output_stride, pretrained_backbone=pretrained_backbone
    )
...
def deeplabv3plus_hrnetv2_48(num_classes=21, output_stride=4, pretrained_backbone=False):  # no pretrained backbone yet
    return _load_model(
        "deeplabv3plus", "hrnetv2_48", num_classes, output_stride, pretrained_backbone=pretrained_backbone
    )


def deeplabv3plus_hrnetv2_32(num_classes=21, output_stride=4, pretrained_backbone=True):
    return _load_model(
        "deeplabv3plus", "hrnetv2_32", num_classes, output_stride, pretrained_backbone=pretrained_backbone
    )
...
def deeplabv3plus_resnet101(num_classes=21, output_stride=8, dgf=False, pretrained_backbone=False):
    """
    Constructs a DeepLabV3+ model with a ResNet-101 backbone.
